...
from main import data_for_product
...
def train_prophet_model(df, prod):
    ...
    df = prod_df[['Date', 'Sale_quantity_final', 'Mieszkania', 'CPI', 'Wsk_bud_mont', 'Sum_q_other_prod_by_month', 'Promo_ind', 'Promo_ind_all']]
    ...
    # model.add_regressor('Sum_q_other_prod_by_month')
...
def main():
    ...
    st.title('Prognoza danych sprzedażowych')
